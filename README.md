...
###### Description
 This CA App Synthetic Monitor (CA ASM) action pack used to support the CA App Synthetic Monitor (CA ASM) feature on Automic Automation. [Check the Feature support by action pack](source/README.md)
